...
while(1):
    # try:
        connToko = pymysql.connect(host='remotemysql.com', user='IAQH64R4U7', passwd='9IT5Ffd4ih', db='IAQH64R4U7')
        connBank = pymysql.connect(host='remotemysql.com', user='3Xk10uTGIz', passwd='EqqSTzlMWG', db='3Xk10uTGIz')
